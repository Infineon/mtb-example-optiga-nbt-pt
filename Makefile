...
APPNAME=mtb-example-optiga-nbt-pt
...
DEFINES=IFX_T1PRIME_INTERFACE_I2C CY_RETARGET_IO_CONVERT_LF_TO_CRLF IFX_APDU_PROTOCOL_LOG_ENABLE

# Required NBT interrupt pin
ifndef NBT_PIN_IRQ
...
DEFINES+=NBT_PIN_IRQ=$(NBT_PIN_IRQ)
